...
DATA_PROCESSORS = {
    ...
    'panstarrs_photometry': 'mop.processors.panstarrs_processor.PanstarrsProcessor',
}
...
EXTRA_FIELDS = [
                ...
                # {'name': 'Sky_location', 'type':'string', 'default':'Unknown'},
                # {'name': 't0','type':'number','default':0},
                # {'name': 't0_error','type':'number','default':0},
                # {'name': 'u0','type':'number','default':0},
                # {'name': 'u0_error','type':'number','default':0},
                # {'name': 'tE','type':'number','default':0},
                # {'name': 'tE_error','type':'number','default':0},
                # {'name': 'piEN','type':'number','default':0},
                # {'name': 'piEN_error','type':'number','default':0},
                # {'name': 'piEE','type':'number','default':0},
                # {'name': 'piEE_error','type':'number','default':0},
                # {'name': 'rho','type':'number','default':0},
                # {'name': 'rho_error','type':'number','default':0},
                # {'name': 's','type':'number','default':0},
                # {'name': 's_error','type':'number','default':0},
                # {'name': 'q','type':'number','default':0},
                # {'name': 'q_error','type':'number','default':0},
                # {'name': 'alpha','type':'number','default':0},
                # {'name': 'alpha_error','type':'number','default':0},
                # {'name': 'Source_magnitude','type':'number','default':0},
                # {'name': 'Source_mag_error','type':'number','default':0},
                # {'name': 'Blend_magnitude','type':'number','default':0},
                # {'name': 'Blend_mag_error','type':'number','default':0},
                # {'name': 'Baseline_magnitude','type':'number','default':0},
                # {'name': 'Baseline_mag_error','type':'number','default':0},
                # {'name': 'Gaia_Source_ID','type':'string','default':''},
                # {'name': 'Gmag', 'type': 'number', 'default': 0},
                # {'name': 'Gmag_error', 'type': 'number', 'default': 0},
                # {'name': 'RPmag', 'type': 'number', 'default': 0},
                # {'name': 'RPmag_error', 'type': 'number', 'default': 0},
                # {'name': 'BPmag', 'type': 'number', 'default': 0},
                # {'name': 'BPmag_error', 'type': 'number', 'default': 0},
                # {'name': 'BP-RP', 'type': 'number', 'default': 0},
                # {'name': 'BP-RP_error', 'type': 'number', 'default': 0},
                # {'name': 'Reddening(BP-RP)', 'type': 'number', 'default': 0},
                # {'name': 'Extinction_G', 'type': 'number', 'default': 0},
                ...
                # {'name': 'TAP_priority_error', 'type': 'number', 'default': ''},
                # {'name': 'TAP_priority_longtE', 'type': 'number', 'default': ''},
                # {'name': 'TAP_priority_longtE_error', 'type': 'number', 'default': ''},
